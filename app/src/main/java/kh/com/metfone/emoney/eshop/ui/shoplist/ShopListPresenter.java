...
public class ShopListPresenter extends BaseSaveLogCheckAuthenPresenter<ShopListMvpView> {
    private final GetChainListUseCase getChainListUseCase;
    private final SharePreferenceHelper sharePreferenceHelper;

    @Inject
    protected ShopListPresenter(ClientLogUseCase clientLogUseCase, LogoutUseCase logoutUseCase,
                                GetChainListUseCase getChainListUseCase,
    ...
    protected void getChainList() {
        ...
        ClientLog clientLog = new ClientLog(DateUtils.formatDateTime(Calendar.getInstance().getTime(), DateUtils.PATTERN_DD_MM_YYYY_HH_MM_SS),
                ...
                "shop/chain",
                ShopListPresenter.class.getName(),
                "getChainList");
