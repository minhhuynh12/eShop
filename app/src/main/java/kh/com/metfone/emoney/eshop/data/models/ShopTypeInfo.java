...
public class ShopTypeInfo extends RealmObject {
    ...
    private RealmList<ShopSubTypeInfo> subShopTypes ;
    ...
    public RealmList<ShopSubTypeInfo> getSubShopTypes() {
        return subShopTypes;
    }
    ...
    public void setSubShopTypes(RealmList<ShopSubTypeInfo> subShopTypes) {
