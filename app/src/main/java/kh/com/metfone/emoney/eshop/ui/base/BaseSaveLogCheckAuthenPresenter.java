 ...
 */
public class BaseSaveLogCheckAuthenPresenter<V extends MvpView> implements Presenter<V> {
    protected final ClientLogUseCase clientLogUseCase;
    protected final LogoutUseCase logoutUseCase;
    private V mMvpView;

    @Inject
    protected BaseSaveLogCheckAuthenPresenter(ClientLogUseCase clientLogUseCase, LogoutUseCase logoutUseCase) {
    ...
    public ClientLogUseCase getClientLogUseCase() {
        return clientLogUseCase;
    }
